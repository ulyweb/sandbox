...
function Start-PS {
    ...
    # REMOVED -NoExit: The PowerShell window will now close once the script finishes.
...
if ($launchingSandbox) {
    # Optional helpers — these run in the background and close on completion.
    ...
    # This process WAITS for Winget to install completely.
    ...
    # This runs in a new window and closes on completion.
...
Write-Host "`nSandboxStartup.ps1 complete. Closing main window..."
# This closes the main PowerShell window that runs the script.
Exit
